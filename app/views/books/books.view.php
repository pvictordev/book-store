...
<div class="container mx-auto p-4">
    ...
    <div id="books-container" class="bg-white flex flex-wrap gap-2 p-4 rounded-lg shadow-2xl">
        <?php foreach ($books as $book) : ?>

            <div class="bg-white relative p-6 rounded-lg shadow-2xl max-w-xs w-64 h-72 flex flex-col justify-between">
